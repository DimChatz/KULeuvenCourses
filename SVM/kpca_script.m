...
[lam,U] = kpca(data(:,1:9),'RBF_kernel',sig2,[],approx,nc);
...
xd = denoise_kpca(data(:,1:9),'RBF_kernel',sig2,[],approx,nc);
figure;
hold on;
...
xd2 = denoise_kpca(data2(:,1:9),'RBF_kernel',sig2,[],approx,nc);
figure;
hold on;
